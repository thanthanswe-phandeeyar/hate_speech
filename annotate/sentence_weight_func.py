...
def weight_calculation_sentence(weighted):
    ...
    for index,weight in enumerate(weighted.values):
        ...
        if isinstance(MsgUniSeg,str)==False:pass
        else:
