...
weighted_val_one = pd.read_csv('/home/swift/Documents/hate-speech-new/annotate/annotate_here_one.csv')
weighted_val_two = pd.read_csv('/home/swift/Documents/hate-speech-new/annotate/annotate_here_two.csv')
weighted_val_three = pd.read_csv('/home/swift/Documents/hate-speech-new/annotate/annotate_here_three.csv')

weighted_val_new =weighted=weighted_val_one.append((weighted_val_two,weighted_val_three),ignore_index=True)

weighted =weighted_val_new[['LexFound','MsgUniSeg','NewHSWordInSentence']]
...
lexicon_pd =pd.read_csv('/home/swift/Documents/hate-speech-new/annotate/accuracy-folder/accuracy.csv',sep='~')
...
weight_pd =weight_pd.to_csv('/home/swift/Documents/hate-speech-new/annotate/weight.csv')
